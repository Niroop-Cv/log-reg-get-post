...
import 'package:flutter_application_5/Datapages/home_cubit.dart';
...
class datas extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => HomeSCubit(context),
        child: BlocBuilder<HomeSCubit, HomeState>(builder: (context, state) {
          if (state is viewall) {
            return Column(
              children: [
                Expanded(
