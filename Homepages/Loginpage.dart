...
import 'package:flutter_application_5/Homepages/hey_cubit.dart';
...
class login extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => HomezCubit(),
      child: BlocBuilder<HomezCubit, HomezState>(
        builder: (context, state) {
          final cubit = context.read<HomezCubit>();
          return Scaffold(
